...
- **Not Notification Center.** Persistent, semantic, agentic — different shape entirely
...
Support for v1 will move to community channels (Discord, GitHub Discussions); direct support from the publisher will focus primarily on v2 and later releases.
...
### Can I use Tempo for non-homelab things — work alerts, personal automations?
...
Yes. The public catalog at [github.com/caereforge/tempo-scores](https://github.com/caereforge/tempo-scores) accepts community contributions. Submit a PR; maintainers review for safety and quality before merge.
...
- **Dismissed** = "I've handled this, get it out of my way." Event drops off the active feed; still in the database
...
Tempo's application code is closed-source. The score schema is open and the public catalog repo is open-source — we welcome score contributions. The app itself is closed for V1 freeware; whether to open later is a decision that hasn't been made.
