...
Installing a score is straightforward: download it, double-click it, the installer window opens, and the score is ready to go.
...
Tempo is open to the community and it handles a wide range of inputs, pretty much all the common ones across self-hosted and cloud tools. Discussion happens in [the Discord](https://tempoapp.app/discord/) (link in the menu), and PRs to the score catalog get reviewed and merged.
