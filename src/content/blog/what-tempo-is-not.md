...
I can mark a task as completed, and a green badge tells me so. I can also acknowledge an event, which hides it from the timeline but keeps it in the history, in case I want to bring it back. If a calendar event carries a meeting link, I can jump straight into the app (or the web URL) to join it. But not much more than that.
