...
- **[Download the DMG](https://downloads.tempoapp.app/Tempo-latest.dmg)** (~13 MB, signed and notarized for Developer ID, macOS 15+). You can also choose to use Homebrew.
