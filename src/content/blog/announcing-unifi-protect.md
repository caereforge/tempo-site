...
I'm happy to announce that as of today, Protect is also available as a source inside Tempo — and it can render the same thumbnail Protect uses for motion detection directly in the action panel.
