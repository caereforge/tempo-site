...
To make up for the missing builder, Tempo ships with **scores**: small declarative files (`.tempo-score`) that carry the intelligence behind Tempo's actions. They're freely downloadable and human-readable, and they can add new modules (Proxmox, Uptime Kuma, and more), bundle ready-to-use scripts to validate sources and custom payloads, or register new click-through reactions in the Action Panel.
